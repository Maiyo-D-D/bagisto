...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_bundle_option_translations', function (Blueprint $table) {
            ...
            $table->foreign('product_bundle_option_id', 'product_bundle_option_translations_option_id_foreign')->references('id')->on('product_bundle_options')->onDelete('NO ACTION');
        });
    }
